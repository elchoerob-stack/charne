...
- **Your teammates move with you.** The **Drag** chip cycles three modes: **Me** (move only your player), **Team** (players near you drift to hold the shape, like a real line adjusting), and **Line** (the complete backline translates with you — set the whole line's depth and width exactly where you want it; the 9 and bound forwards hold their posts).
